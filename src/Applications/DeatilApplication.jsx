...
useEffect(()=>{
  ...
  const response=await axios.get(`https://internareabackend-xz9i.onrender.com/api/application/${id}`)
...
const handleAcceptAndReject= async(id,action)=>{
  try {
    const response=await axios.put(`https://internareabackend-xz9i.onrender.com/api/application/${id}`,{action})
