...
if (username===""||password==="") {
    ...
    axios.post("https://internareabackend-xz9i.onrender.com/api/admin/adminLogin",bodyjson).then((res)=>{
  ...
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2">
        <div class="p-2 w-1/2">
          <div class="relative">
            <label for="name" class="leading-7 text-sm text-black">Admin Name</label>
        ...
        <div class="p-2 w-1/2">
          <div class="relative">
            <label for="pass" class="leading-7 text-sm text-black">Password</label>
