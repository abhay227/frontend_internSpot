...
function PostJob() {
  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <form class="mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2" onSubmit={sendData}>
      ...
      <div class="sm:col-span-2">
        <label for="aboutInternship" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">aboutJob*</label>
     ...
     <button  className='hover:bg-blue-600 rounded-xl'>Post Job</button>
    </form>
  </div>
</div>
  )
